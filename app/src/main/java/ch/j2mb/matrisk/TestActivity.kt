...
class TestActivity : AppCompatActivity(), ReinforcementFragment.ReinforcementInterface {
    ...
    fun testToaster() {
        Toast.makeText(this@TestActivity, "Toaster clicked!!!!", Toast.LENGTH_LONG).show()
    }
